!function (a) {
    ...
    function c(b) {
        a(b).closest(".form-group").addClass("is-focused")
    }
    ...
    a.expr[":"].notmdproc = function (b) {
        ...
        options: {
            ...
            a(".form-group .checkbox label").hover(function () {
                c(this)
            }, function () {
                d(this)
                ...
                var b = a(this), c = b.closest(".form-group"), d = "undefined" == typeof b[0].checkValidity || b[0].checkValidity();
                "" === b.val() && d ? c.addClass("is-empty") : c.removeClass("is-empty"), d ? c.removeClass("has-error") : c.addClass("has-error")
            ...
            }), this.options.input && b.arrive(this.options.inputElements, function () {
                a.material.input(a(this))
            }), this.options.checkbox && b.arrive(this.options.checkboxElements, function () {
                a.material.checkbox(a(this))
            }), this.options.radio && b.arrive(this.options.radioElements, function () {
                a.material.radio(a(this))
            }), this.options.togglebutton && b.arrive(this.options.togglebuttonElements, function () {
