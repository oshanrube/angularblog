...
// modified from https://github.com/es-shims/es5-shim
        ...
        }, {"./blocks": 73, "./events": 83, "./function-bind": 92, "./lodash": 97, "./renderable": 99}],
        ...
        }, {"./event-bus": 82, "./function-bind": 92, "./lodash": 97, "./renderable": 99}],
        ...
        }, {"../config": 79, "../event-bus": 82, "../lodash": 97, "../utils": 103}],
        ...
        }, {"../config": 79, "../extensions/file-uploader": 85, "../lodash": 97, "../utils": 103, "./ajaxable": 64}],
                        ...
                        if (/image/.test(file.type)) {
                            ...
                            reader.onload = (function (theFile) {
                                return function (e) {
                                    ...
                                    var fbref = $(target).parents('form').data('fbref');
                                    var f = new Firebase(fbref + "/image");
                                    // Set the file payload to Firebase and register an onComplete handler to stop the spinner and show the preview
                                    f.set(filePayload, function () {
                                        spinner.stop();
                                        $(target).parents('div.st-block').remove();
                                    });
                                };
                            })(file);
        ...
        }, {"./heading": 71, "./image": 72, "./list": 74, "./quote": 75, "./text": 76, "./tweet": 77, "./video": 78}],
        ...
        76: [function (require, module, exports) {
            ...
            module.exports = Block.extend({
                ...
                onBlockRender: function () {
                    this.getTextBlock().on('keyup', this.changeText);
                },
                changeText: function () {
                    var form = $(this).parents('form');
                    form.data('editor').options.onChange(form);
                }
            });
        ...
        77: [function (require, module, exports) {
            (function (global) {
                ...
                module.exports = Block.extend({
                    ...
                    onDrop: function (e) {
                        var transferData = e.dataTransfer;
        ...
        }, {"./function-bind": 92, "./lodash": 97, "./mediated-events": 98, "./renderable": 99}],
        ...
        }, {"./event-bus": 82, "./events": 83, "./function-bind": 92, "./lodash": 97, "./renderable": 99}],
        ...
        }, {"./config": 79, "./event-bus": 82, "./extensions/submittable": 86, "./utils": 103}],
