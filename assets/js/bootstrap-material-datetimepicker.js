(function ($, moment) {
    ...
    Plugin.prototype =
    {
        init: function () {
            ...
            this._attachEvent(this.$element, 'click', this._onFocus.bind(this));
        },
        initDays: function () {
            this.days = [];
        ...
        initDates: function () {
            if (this.$element.val().length > 0) {
                ...
                if (typeof(this.$element.attr('value')) !== 'undefined' && this.$element.attr('value') !== null && this.$element.attr('value') !== "") {
                    ...
                    else if (typeof this.$element.text() === 'string') {
                        this.currentDate = moment(this.$element.text(), this.params.format).locale(this.params.lang);
                    }
                    else {
        ...
        setElementValue: function () {
            ...
            this.params.onSetValue(moment(this.currentDate).locale(this.params.lang).format(this.params.format));
        },
